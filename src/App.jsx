...
const STORAGE_KEY_INVOICES = "fyscaly_invoices";
const STORAGE_KEY_USER = "fyscaly_user";
...
function App() {
  ...
  const handleLogout = () => {
    if (window.confirm("Sair do Fyscaly neste dispositivo?")) {
      setUser(null);
    ...
    <div className="app">
      <header className="app-header">
        <div className="app-header-left">
          <img src="/logo.jpg" alt="Fyscaly" className="app-logo" />
          <div>
            <h1 className="app-title">Fyscaly</h1>
      ...
      <footer className="app-footer">
        <span>Fyscaly · {new Date().getFullYear()}</span>
